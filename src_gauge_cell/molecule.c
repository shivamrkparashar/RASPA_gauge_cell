...
void ReadComponentDefinition(int comp)
{
  ...
  Components[comp].CpuTimeGaugeCellSwapMoveInsertion=(REAL*)calloc(NumberOfSystems,sizeof(REAL));
  Components[comp].CpuTimeGaugeCellSwapMoveDeletion=(REAL*)calloc(NumberOfSystems,sizeof(REAL));
...
void RescaleComponentProbabilities(void)
{
  ...
  for(i=0;i<NumberOfComponents;i++)
  {
    TotProb=Components[i].ProbabilityTranslationMove+
            ...
            Components[i].ProbabilityGaugeCellSwapMove+      // Shivam
    ...
    if(TotProb>1e-5)
    {
      ...
      Components[i].ProbabilityGaugeCellSwapMove/=TotProb;   // Shivam
    ...
    Components[i].FractionOfGaugeCellSwapMove=Components[i].ProbabilityGaugeCellSwapMove - Components[i].ProbabilitySwapMove;
...
void PrintCPUStatistics(FILE *FilePtr)
{
  ...
  REAL CpuTimeGaugeCellSwapMoveInsertion,CpuTimeGaugeCellSwapMoveDeletion;
  ...
  CpuTimeGaugeCellSwapMoveInsertion=0.0;
  CpuTimeGaugeCellSwapMoveDeletion=0.0;
  ...
  for(i=0;i<NumberOfComponents;i++)
  {
    ...
    fprintf(FilePtr,"\tgauge cell swap (insertion):        %18.10g [s]\n",Components[i].CpuTimeGaugeCellSwapMoveInsertion[CurrentSystem]);
    fprintf(FilePtr,"\tgauge cell swap (deletion):         %18.10g [s]\n",Components[i].CpuTimeGaugeCellSwapMoveDeletion[CurrentSystem]);
    ...
    CpuTimeGaugeCellSwapMoveInsertion+=Components[i].CpuTimeGaugeCellSwapMoveInsertion[CurrentSystem];
    CpuTimeGaugeCellSwapMoveDeletion+=Components[i].CpuTimeGaugeCellSwapMoveInsertion[CurrentSystem];
  ...
  fprintf(FilePtr,"\tgauge cell swap (insertion):        %18.10g [s]\n",CpuTimeGaugeCellSwapMoveInsertion);
  fprintf(FilePtr,"\tgauge cell swap (deletion):         %18.10g [s]\n",CpuTimeGaugeCellSwapMoveDeletion);
  ...
  for(j=0;j<NumberOfSystems;j++)
  {
    for(i=0;i<NumberOfComponents;i++)
    {
      ...
      CpuTimeGaugeCellSwapMoveInsertion+=Components[i].CpuTimeGaugeCellSwapMoveInsertion[j];
      CpuTimeGaugeCellSwapMoveDeletion+=Components[i].CpuTimeGaugeCellSwapMoveInsertion[j];
...
void WriteRestartComponent(FILE *FilePtr)
{
  ...
  for(i=0;i<NumberOfComponents;i++)
  {
    ...
    fwrite(Components[i].CpuTimeGaugeCellSwapMoveInsertion,sizeof(REAL),NumberOfSystems,FilePtr);
    fwrite(Components[i].CpuTimeGaugeCellSwapMoveDeletion,sizeof(REAL),NumberOfSystems,FilePtr);
...
void ReadRestartComponent(FILE *FilePtr)
{
  ...
  for(i=0;i<NumberOfComponents;i++)
  {
    ...
    Components[i].CpuTimeGaugeCellSwapMoveInsertion=(REAL*)calloc(NumberOfSystems,sizeof(REAL));
    Components[i].CpuTimeGaugeCellSwapMoveDeletion=(REAL*)calloc(NumberOfSystems,sizeof(REAL));
    ...
    fread(Components[i].CpuTimeGaugeCellSwapMoveInsertion,sizeof(REAL),NumberOfSystems,FilePtr);
    fread(Components[i].CpuTimeGaugeCellSwapMoveDeletion,sizeof(REAL),NumberOfSystems,FilePtr);
