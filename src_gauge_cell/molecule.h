...
typedef struct Component
{
  ...
  REAL *ChemicalPotential;         // the chemical potential of the component per system
  ...
  REAL ProbabilityGaugeCellSwapMove;  // Shivam
  ...
  REAL *CpuTimeGaugeCellSwapMoveInsertion; // Shivam
  REAL *CpuTimeGaugeCellSwapMoveDeletion;
  ...
  REAL FractionOfGaugeCellSwapMove;   // Shivam
