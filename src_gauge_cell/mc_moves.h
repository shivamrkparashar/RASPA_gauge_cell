...
void GaugeCellSwapAddMove(void);
void GaugeCellSwapRemoveMove(void);
...
void PrintGaugeCellSwapAddStatistics(FILE *FilePtr);
void PrintGaugeCellSwapRemoveStatistics(FILE *FilePtr);
